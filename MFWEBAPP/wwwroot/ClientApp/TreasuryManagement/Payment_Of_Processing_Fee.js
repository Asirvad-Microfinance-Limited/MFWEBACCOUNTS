var ProcFeeNew = {
    ...
    checkAccess: function () {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/PayratQueries", CheckAccess, ProcFeeNew.checkAccessRtn, token)
    },
        ...
        if (response.status === "SUCCESS") {
            ...
            if (response.data != null && response.data.queryResult.QueryResult.length > 0) {
                ...
                if (x == "0") {
                    ...
                    ProcFeeNew.loadSelectFinancialInstitution();
                }
    ...
    _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/UserSession", CheckToken, ProcFeeNew.checkAccessToken, userdata.token)
},
...
checkAccessToken: function (response) {
    ...
    loadSelectFinancialInstitution: function () {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebSelectFinancialInstitution, ProcFeeNew.FillDebSelectFinancialInstitution, userdata.token);
    ...
    loadSelectFund: function (indata) {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebSelectFund, ProcFeeNew.FillDebSelectFund, userdata.token);
    ...
    getFromLoanDtls: function () {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", FromLoanDtls, ProcFeeNew.FillTable, userdata.token);

    },
    //FromLoanDtlsResponse: function (Response) {
    //    if (Response.status === "SUCCESS") {

    //        ProcFeeNew.FillTable(Response);
    ...
    loadBankAccount: function () {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebBankAccount, ProcFeeNew.FillDebBankAccount, userdata.token);
    ...
    loadBankSubAccount: function (indata) {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebBankSubAccount, ProcFeeNew.FillDebBankSubAccount, userdata.token);
    ...
    loadContraMainAccountt: function () {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebContraMainAccount, ProcFeeNew.FillDebContraMainAccount, userdata.token);
    ...
    loadContraSubAccount: function (indata) {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebContraSubAccount, ProcFeeNew.FillDebContraSubAccount, userdata.token);
    ...
    loadContraNo: function (indata) {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebContraNo, ProcFeeNew.FillDebContraNo, userdata.token);
    ...
    loadTDSAccount: function () {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebTDSAccount, ProcFeeNew.FillDebTDSAccount, userdata.token);
    ...
    loadTDSSubAccount: function (indata) {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebTDSSubAccount, ProcFeeNew.FillDebTDSSubAccount, userdata.token);
    ...
    submitevalue: function () {
        if (ProcFeeNew.checkvalues()) {
            var ProcFeeType, paymode, mainac, subac, tdsmain, tdssub, tdsamnt;
            ...
            _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasuryConfirmation", submitRequest, ProcFeeNew.SubmitReturn, userdata.token)
    ...
    VerifyIFSC: function () {
        ...
        _http.post(MFPUBLICCUSTOMERAPI_URL + "api/banks/searchifsc", VIfsc, ProcFeeNew.FillIfsc, userdata.token);
    },
...
jQuery(document).ready(function () {
 ...
 //   ProcFeeNew.loadSelectFinancialInstitution();
     ProcFeeNew.tokenValidate();

    ProcFeeNew.loadBankAccount();

    ProcFeeNew.loadContraMainAccountt();

    ProcFeeNew.loadTDSAccount();
    ...
    jQuery('#ddl_fI').on("change", function () {
        ...
        if (indata == 0) {
            ...
            ProcFeeNew.loadSelectFund(indata);
        }
    });
    jQuery('#ddl_Loan').on("change", function () {
        ProcFeeNew.getFromLoanDtls();
    });
    ...
    jQuery('#ddl_mainAcc').on("change", function () {
        ...
        ProcFeeNew.loadBankSubAccount(indata);
    });
    ...
    jQuery('#ddl_contramainAcc').on("change", function () {
        ...
        if (indata == '36045') {
            ...
            var indata = jQuery("#ddl_contramainAcc").val();
            ProcFeeNew.loadContraSubAccount(indata);
        }
    });
    jQuery('#txt_pjt').on("change", function () {
        ...
        ProcFeeNew.loadContraNo(indata);
    });
