var IpoNoc = {
    ...
    checkAccess: function () {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/PayratQueries", CheckAccess, IpoNoc.checkAccessRtn, token)
    },
        ...
        if (response.status === "SUCCESS") {
            ...
            if (response.data != null && response.data.queryResult.QueryResult.length > 0) {
                ...
                if (x == "0") {
                    ...
                    IpoNoc.loadSelectFinancialInstitution();
                }
    ...
    _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/UserSession", CheckToken, IpoNoc.checkAccessToken, userdata.token)
},
...
checkAccessToken: function (response) {
    ...
    loadSelectFinancialInstitution: function () {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebSelectFinancialInstitution, IpoNoc.FillDebSelectFinancialInstitution, userdata.token);
    ...
    loadSelectFund: function (indata) {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebSelectFund, IpoNoc.FillDebSelectFund, userdata.token);
    ...
    getFromLoanDtls: function () {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", FromLoanDtls, IpoNoc.FillTable, userdata.token);

    },
    //FromLoanDtlsResponse: function (Response) {
    //    if (Response.status === "SUCCESS") {

    //        IpoNoc.FillTable(Response);
    ...
    loadBankAccount: function () {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebBankAccount, IpoNoc.FillDebBankAccount, userdata.token);
    ...
    loadBankSubAccount: function (indata) {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebBankSubAccount, IpoNoc.FillDebBankSubAccount, userdata.token);
    ...
    loadContraMainAccountt: function () {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebContraMainAccount, IpoNoc.FillDebContraMainAccount, userdata.token);
    ...
    loadContraSubAccount: function (indata) {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebContraSubAccount, IpoNoc.FillDebContraSubAccount, userdata.token);
    ...
    loadContraNo: function (indata) {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebContraNo, IpoNoc.FillDebContraNo, userdata.token);
    ...
    loadTDSAccount: function () {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebTDSAccount, IpoNoc.FillDebTDSAccount, userdata.token);
    ...
    loadTDSSubAccount: function (indata) {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasurySelectQueries", DebTDSSubAccount, IpoNoc.FillDebTDSSubAccount, userdata.token);
    ...
    checkvalues: function () {
        ...
        if (jQuery("#ddl_fI").val() == "0") {
            ...
            swal("Please select an Option - IGST/SGST & CGST..!");
            //alert("Please select an Option");
            return false;
        }
        else if (jQuery("#txt_docfee").val() == "") {
            swal("Please Enter Processing Fee...!!!");
            return false;
        }
    ...
    submitevalue: function () {
        if (IpoNoc.checkvalues()) {
            var NocFeeType, paymode, mainac, subac, tdsmain, tdssub, tdsamnt;
            ...
            var InputData = NocFeeType + "µ" + jQuery("#ddl_Loan").val() + "µ" + jQuery("#txt_docfee").val() + "µ" + mainac + "µ" + subac + "µ" + jQuery("#ddl_contramainAcc").val() + "µ" + jQuery("#ddl_contraSubAcc").val() + "µ" + jQuery("#ddl_contraFIID").val() + "µ" + jQuery("[id*=hdUserId3]").val() + "µ" + jQuery("#txt_ifsc").val() + "µ" + jQuery("#txt_Accnumber").val() + "µ" + jQuery("#txt_Mobnumber").val() + "µ" + jQuery("#txt_Accname").val() + "µ" + paymode + "µ" + jQuery("#txt_pjt").val() + "µ" + tdsmain + "µ" + tdssub + "µ" + tdsamnt;;
        }
        var submitRequest = {
        ...
        _http.post(MFPUBLICTREASURYAPI_URL + "api/Treasury/TreasuryConfirmation", submitRequest, IpoNoc.SubmitReturn, userdata.token)
    ...
    VerifyIFSC: function () {
        ...
        _http.post(MFPUBLICCUSTOMERAPI_URL + "api/banks/searchifsc", VIfsc, IpoNoc.FillIfsc, userdata.token);
    },
...
jQuery(document).ready(function () {
    ...
    IpoNoc.tokenValidate();
    // IpoNoc.loadSelectFinancialInstitution();

    IpoNoc.loadBankAccount();

    IpoNoc.loadContraMainAccountt();

    IpoNoc.loadTDSAccount();
    ...
    jQuery('#ddl_maintds').on("change", function () {
        ...
        IpoNoc.loadTDSSubAccount(indata);
    });
