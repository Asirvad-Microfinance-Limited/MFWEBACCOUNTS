...
var _CreditInBankUpload = {
    bankLoad: function () {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/disbursementEntryUpdation", bankFillData, _CreditInBankUpload.bankFillDataLoadCompleated, userdata.token)
    },
    ...
    ExcelDataUpload: function () {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/disbursementEntryUpdation", UploadRequest, _CreditInBankUpload.ExcelDataUploadLoadCompleated, userdata.token)
    },
    ...
    GetData: function () {
        ...
        if (filename != "CreditInBankUploadTemplates.xlsx") {
            jQuery('.page-loader-wrapper').hide();
...
function ProcessExcel(data) {
    ...
    for (var i = 0; i < excelRows.length; i++) {
        ...
        cell.innerHTML = excelRows[i].LOAN_ID != '' ? excelRows[i].LOAN_ID : 0;
        excelRows[i].LOAN_ID = excelRows[i].LOAN_ID != '' ? excelRows[i].LOAN_ID : 0;
