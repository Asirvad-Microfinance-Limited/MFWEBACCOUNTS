...
var _AddPayData = {
    ...
    GetPayData: function () {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/GlexpensesEnterAPI", GetPayTypeData, _AddPayData.FillPayType,token)
    ...
    GetReqData: function (val) {
        ...
        GetPayTypeData = JSON.stringify(GetPayTypeData);
        GetPayTypeData = { "encryptedRqstStr": EncryptAPIReq(GetPayTypeData) };
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/GlexpensesEnterAPI", GetPayTypeData, _AddPayData.FillReqType, token)
    ...
    submitdata: function () {
        ...
        if (val2 != 0) {
            ...
            GetPayTypeData = JSON.stringify(GetPayTypeData);
            GetPayTypeData = { "encryptedRqstStr": EncryptAPIReq(GetPayTypeData) };
            _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/GlexpensesEnterAPI", GetPayTypeData, _AddPayData.FillsubmitData,token)
        } else {
    ...
    GetRemarksData: function (val) {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/GlexpensesEnterAPI", GetGLReqData, _AddPayData.FillRemarkData, token)
