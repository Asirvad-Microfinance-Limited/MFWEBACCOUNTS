var _InternalAuditObservation = {
    checkAccess: function () {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/PayratQueries", CheckAccess, _InternalAuditObservation.checkAccessRtn, userdata.token)
    },
    ...
    GetOutwardData: function () {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/PayratQueries", GetPayTypeData, _InternalAuditObservation.FillOutwardData, userdata.token)
    ...
    GetPRData: function (stateID, brtype, fromdate, todate) {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/PayratQueries", GetPayTypeData, _InternalAuditObservation.FillPRData, userdata.token)
        ...
        if (response.status === "SUCCESS") {
            ...
            if (response.data.queryResult.length > 0) {
                ...
                jQuery.each(response.data.queryResult, function (i, val) {
                    ...
                    $row.append(jQuery('<td class="HCol" align="center">').html('<button type="button" class="btn btn-link" id="viewinvoice' + i + '" onclick="_InternalAuditObservation.getCollectionName(\'' + data1[1] + '\');">View Bill</button>'));
    ...
    confdata: function (prid, reason) {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/PayratQueries", GetOutWardData, _InternalAuditObservation.Fillconfdata, userdata.token)
        //}
        //else {
        //    jQuery('.page-loader-wrapper').hide();
    ...
    viewInvoiceImages: function (x) {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/images", invimagemageData, _InternalAuditObservation.viewInvoiceImagesLoadCompleted, userdata.token)
    },
    ...
    getBranchType: function (stateID) {
        ...
        _http.post(MFPUBLICACCOUNTSAPI_URL + "api/accounts/PayratQueries", GetPayTypeData, _InternalAuditObservation.FillBranchType, userdata.token)
...
jQuery(document).ready(function ($) {
    _InternalAuditObservation.checkAccess();
    jQuery('.page-loader-wrapper').hide();
    ...
    jQuery('#ddlOutWard').change(function (e) {
        ...
        if (outward != 0) {
            //nval = 0;
            //checkarr = [];
            _InternalAuditObservation.getBranchType(outward);
    ...
    jQuery('#toDate').change(function (e) {
        ...
        _InternalAuditObservation.GetPRData(state, brType, fromdate, todate);
    ...
    jQuery('#ddlPRselect').change(function (e) {
        ...
        if (pr != 0) {
            ...
            _InternalAuditObservation.GetPRFullData(pr);
        }
    });
    ...
    jQuery('#submit').click(function (e) {
        ...
        _InternalAuditObservation.AddRemarks()
        if (pr != 0 || remarks == null) {
            _InternalAuditObservation.confdata(1, "");
        }
    });
    ...
    jQuery('#rejectReason').click(function (e) {
        ...
        if (rejreason != "" && rejreason != null) {
            ...
            _InternalAuditObservation.confdata(prid, rejreason);
        }
        else {
...
_InternalAuditObservation.GetOutwardData();
